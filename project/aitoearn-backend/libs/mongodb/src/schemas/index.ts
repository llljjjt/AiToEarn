...
import { TeamAccountGroup, TeamAccountGroupSchema } from './team-account-group.schema'
...
export * from './team-account-group.schema'
...
export const schemas = [
  ...
  { name: TeamAccountGroup.name, schema: TeamAccountGroupSchema },
